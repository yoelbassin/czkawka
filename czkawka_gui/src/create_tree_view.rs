...
use crate::gui_structs::common_tree_view::{create_default_columns, create_default_selection_button_column, ColumnSort};
...
pub(crate) fn create_tree_view_included_directories(tree_view: &TreeView) {
    ...
    create_default_columns(
        tree_view,
        &[
            (ColumnsIncludedDirectory::Path as i32, ColumnSort::Default),
        ],
        None,
    );
...
pub(crate) fn create_tree_view_excluded_directories(tree_view: &TreeView) {
    ...
    create_default_columns(
        tree_view,
        &[
            (ColumnsExcludedDirectory::Path as i32, ColumnSort::Default),
        ],
        None,
    );
}
